        ...
        <div class="col-lg-3 pb-3">
            <form action={{ route('filter') }} method="GET">
                ...
                <div class="filter-1 bg-white rounded p-3">
                    ...
                    @foreach ($catalogs as $catalog)
                        <div class="mb-0 form-check">
                            <input type="checkbox" class="form-check-input" id="check1" name="catalog[]"
                                value="{{ $catalog->id }}" />
                ...
                <div class="filter-1 bg-white rounded p-3 mt-3">
                    ...
                    <input type="range" class="form-range" id="minRange" name="min_price" min="1000000"
                        max="50000000" value="1000000">
                    <input type="range" class="form-range" id="maxRange" name="max_price" min="1000000"
            ...
            <section class="bg-white  p-3 pt-2 pb-2 rounded d-flex align-items-center">
                ...
                <div class="">
                    <form id="sortForm" action={{ route('sort') }} method="GET">
                        <select id="sortSelect" class="form-select border-0" aria-label="Default select example"
                            name="sort">
